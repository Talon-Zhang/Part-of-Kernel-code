...
void entry(unsigned long magic, unsigned long addr) {
    ...
    /* init keyboard */
    enable_irq(IRQ_KEYBOARD); //keyboard

    /* enable irq for rtc */
    enable_irq(IRQ_RTC);//rtc
    init_syscall();
    ...
    fs_init(addr_boot_block);
   
    sti();
    clear();
    // print_file_by_name("cat");
